...
var _usv = "http://localhost:8084/dynamicweb/ui/sys/category/update";
var _ush = "http://localhost:8084/dynamicweb/ui/sys/category/";
var _usrc = "http://localhost:8084/dynamicweb/ui/sys/category/";

var _form = {
		"fields" : [
					{"_label":"CID","_type":"HD","_name":"cid","other":"","_regex":"","_src":""},
		            {"_label":"Name","_type":"TX","_name":"name","other":"","_regex":"","_src":""},
		            {"_label":"Label","_type":"TX","_name":"code","other":"","_regex":"","_src":""},
...
var _search = {
		"fields" : [
					...
					{"_label":"Code","_type":"TX","_name":"_src_code","other":"","_regex":"","_src":""}
		            ]
}
...
var _arecord = function(_url, _p, _prc){
	_doQ(_url, _p, _prc);
}
...
var __arecord = function __showARecord(_d){
	...
	_nid = "#"+_form.fields[2]._name; $(_nid).val(_d.list[0].code);
...
$(document).ready(function(){
	...
	$("#_search").click( function(){ 
			...
			_n = $('#_src_code').val().match(/^\w/g);
			if(_n!=null) _p+="/"+$('#_src_code').val(); else _p+="/-";
...
var _doQ = function(_url, _params, _prc){
