...
public class BaseCategoryDAO extends BaseDAO{
	...
	public BCategoryVO getCategories(String nm, String cd){
		try{
			String n = null; String c = null;
			if(nm.equalsIgnoreCase("null")) n = null; else n = nm;
			if(cd.equalsIgnoreCase("null")) c = null; else c = cd;
			...
			if((n!=null || c!=null) && ps!=null){
				int i = 1;
				if(n!=null) ps.setString(i++,"%"+n+"%");
				if(c!=null) ps.setString(i++,"%"+c+"%");
			}
